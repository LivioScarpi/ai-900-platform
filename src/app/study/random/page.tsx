...
export default function RandomSequentialPage() {
  ...
  if (!question) {
    return (
      <div className="px-4 md:px-8 py-6 md:py-8 max-w-2xl mx-auto w-full">
        <p className="label-caps text-ink-faint mb-1">Study / Random Sequential</p>
        <h1 className="font-display text-3xl font-bold text-ink mb-6">All Done!</h1>
        <div className="card p-8 text-center">
          <p className="text-4xl mb-3">🎉</p>
          <p className="text-ink font-semibold mb-4">You&apos;ve completed all questions in random order!</p>
  ...
  return (
    <div className="px-8 py-8 max-w-2xl mx-auto w-full">
      <p className="label-caps text-ink-faint mb-1">Study / <span className="text-ink-muted">Random Sequential</span></p>
